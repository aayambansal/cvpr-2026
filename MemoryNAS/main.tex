...
% Packages
% ---------------------------------------------------------------
\usepackage[letterpaper, left=1.73cm, right=1.73cm, top=2.54cm, bottom=2.54cm]{geometry}
\usepackage{times}
...
\usepackage[pagebackref=false,breaklinks=true,colorlinks=true,linkcolor=linkblue,citecolor=linkblue,urlcolor=linkblue,bookmarks=false]{hyperref}
